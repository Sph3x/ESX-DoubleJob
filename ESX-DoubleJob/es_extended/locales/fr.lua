Locales['fr'] = {
  ...
  ['gave_weapon'] = 'vous avez donner ~y~1x~s~ ~b~%s~s~ avec ~o~%sx~s~ balles.',
  ['received_weapon'] = 'vous avez reçu ~y~1x~s~ ~b~%s~s~ avec ~o~%sx~s~ balles.',
  ['gave_ammo'] = 'vous avez donner ~o~%sx~s~ balles.',
  ['received_ammo'] = 'vous avez reçu ~o~%sx~s~ balles.',
  ...
  ['threw_weapon'] = 'Vous avez ~r~jetés~s~ ~y~1x~s~ ~b~%s~s~ avec ~o~%sx~s~ balles!',
  -- Salary related
  ...
  ['received_paycheck'] = 'Salaire reçu',
